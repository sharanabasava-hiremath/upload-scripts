...
LOCAL_PATH=/Users/hirsh04/Downloads/mapping.txt
...
curl -X POST --verbose -F "file=@$LOCAL_PATH;filename=mapping.txt" "$SERVER/mdo/v3/symbolication/$APP_NAME?app_version=$APPVERSION&platform=$PFORM" -H "Authorization:Bearer $TOKEN"
